...
<li class="has-children">
  ...
  <ul class="child-nav">
    <li><a href="#"><i class="fa fa-plus-square-o"></i> <span>Thêm mới sinh viên</span></a></li>
    <li><a href="index.php"><i class="fa fa-edit"></i> <span >Cập nhật thông tin</span></a></li>
...
<li class="has-children">
  ...
  <ul class="child-nav">
    ...
    <li><a href="manage-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Xóa học phần </span></a></li>
  </ul>
</li>
<!-- end -->
