              ...
              <div class="panel">
                <div class="panel-heading">
                  ...
                  <a href="index.php"> <input type="button" value="X" style="float: right; background-color: #dd3d36;"></a>
                    <h5>DANH SÁCH SINH VIÊN</h5><br> <a href="index.php">Trang chủ |</a>
                    <a href="#" onclick="hienThemSV()"> <input type="button" value="thêm sinh viên"></a>
                  </div>
                </div>
...
";
                      ...
                      ?>
                          ...
                          <tr>
                            ...
                            <td><?php echo htmlentities($row['sdd']); ?></td>
                            <td><?php echo htmlentities($row['email']); ?></td>
                            <td>
                              <a href="sua_sv.php?msv=<?php echo htmlentities($row['msv']); ?>" ><i class="fa fa-edit" title="Sửa"></i></a>

                              &nbsp; | &nbsp;
                              <a onclick="return confirm('bạn có muốn xóa sinh viên này không');" href="xoa_sv.php?smsv=<?php echo htmlentities($row['msv']); ?>"><i class="fa fa-trash" title="Xóa"></i></a>
                            </td>
                          </tr>
