...
$edit_sql = "SELECT * FROM tbl_hocphan WHERE mhp=$mhp";
          ...
          <div class="panel">
            <div class="panel-heading">
              ...
              <a href="index.php"> <input type="button" value="X" style="float: right; background-color: #dd3d36;"></a>
                ...
                <button type="button"><a href="./dsach_hp.php">Trở lại trang </a></button>
              </div>
            </div>
            <div class="panel-body">
              <form method="post" action="update_hp.php">
                <!-- nhập thông tin -->
                <div class="form-group has-success">
                  <label for="success" class="control-label">Mã Học Phần : </label>
                  <div class="">
                    <input type="text" name="mhp" class="form-control" required="required" id="success" value="<?php echo $row['mhp']?>">
                ...
                <div class="form-group has-success">
                  ...
                  <div class="">
                    <input type="text" name="tenhocphan" required="required" class="form-control" id="success" value="<?php echo $row['tenhocphan']?>">
                    <span class="help-block">* không để trống .</span>
                  </div>
                </div>
                <div class="form-group has-success">
                  ...
                  <div class="">
                    <input type="text" name="tinchi" required="required" class="form-control" id="success" value="<?php echo $row['tinchi']?>">
                    <span class="help-block">* không để trống .</span>
                  </div>
